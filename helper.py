...
def create_cloud(selected_user, df):
    ...
    wc = WordCloud(width=500, height=500, min_font_size=10, max_font_size=100, background_color='white')
...
def most_common_words(selected_user, df):
    ...
    return_df = pd.DataFrame(Counter(words).most_common(25)).rename(columns={0:'Word',1:'Count'})
    return return_df
